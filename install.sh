...
docker exec -it mailserver sh -c 'echo "initial_destination_concurrency = 250" >> /etc/postfix/main.cf'
docker exec -it mailserver sh -c 'echo "default_destination_concurrency_limit = 1000" >> /etc/postfix/main.cf'
docker exec -it mailserver sh -c 'echo "default_process_limit = 5000" >> /etc/postfix/main.cf'
